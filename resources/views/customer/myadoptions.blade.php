...
{{-- Options --}}
<label class="input text-white bg-[#0009] outline-none mb-5">
    ...
    $(document).ready(function() {
        ...
        $('body').on('input', '#qsearch', function(event) {
            ...
            if (query != '') {
                ...
                setTimeout(() => {
                    window.location.replace('myadoptions')
                }, 500);
            }
        })
