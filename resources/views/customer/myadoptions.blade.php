...
<div class="datalist flex flex-col gap-4 items-center justify-center">
    ...
    <h4 class="text-white">
        <span class="underline font-bolendforeachd">{{ $adopt->user->name }}</span>
        was adopted by
        <span class="underline font-bold">{{ $adopt->pet->fullname }}</span>
    ...
    @empty
    <p class="text-center text-white my-20">No adoptions found.</p>
    @endforelse
</div>
